...
class Sekre3Controller extends Controller
{
     /**
...

    {
    	$data = DB::table('barang')
    		  ...
    		  ->where('barang.id_kantor', '=', 'K03')
    		  ->get();
    		  return view('sekre3', ['data' => $data]);
    }
    ...
    public function create()
	{
		...
		// memanggil view tambah
		 $kantors = DB::table('kantor')
		 		 ->where('id_kantor', '=', 'K03')
		 		 ->get();
		return view('tambah3', ['kantors' => $kantors , 'id_barang' => $id_barang]); 
	}
	...
	return redirect('/sekre3');
		...
		public function edit3($id)
		{
			...
			return view('edit3',['barang' => $barang]);
