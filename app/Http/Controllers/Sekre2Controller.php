...
class Sekre2Controller extends Controller
{
     /**
...

    {
    	$data = DB::table('barang')
    		  ...
    		  ->where('barang.id_kantor', '=', 'K02')
    		  ->get();
    		  return view('sekre2', ['data' => $data]);
    }
    ...
    public function create()
	{
		...
		// memanggil view tambah
		 $kantors = DB::table('kantor')
		 		 ->where('id_kantor', '=', 'K02')
		 		 ->get();
		return view('tambah2', ['kantors' => $kantors , 'id_barang' => $id_barang]); 
	}
	...
	return redirect('/sekre2');
		...
		public function edit2($id)
		{
			...
			return view('edit2',['barang' => $barang]);
