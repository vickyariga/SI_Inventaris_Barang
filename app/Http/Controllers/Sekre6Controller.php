...
class Sekre6Controller extends Controller
{
     /**
...

    {
    	$data = DB::table('barang')
    		  ...
    		  ->where('barang.id_kantor', '=', 'K06')
    		  ->get();
    		  return view('sekre6', ['data' => $data]);
    }
    ...
    public function create()
	{
		...
		// memanggil view tambah
		 $kantors = DB::table('kantor')
		 		 ->where('id_kantor', '=', 'K06')
		 		 ->get();
		return view('tambah6', ['kantors' => $kantors , 'id_barang' => $id_barang]); 
	}
