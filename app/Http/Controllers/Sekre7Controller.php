...
class Sekre7Controller extends Controller
{
     /**
...

    {
    	$data = DB::table('barang')
    		  ...
    		  ->where('barang.id_kantor', '=', 'K07')
    		  ->get();
    		  return view('sekre7', ['data' => $data]);
    }
    ...
    public function create()
	{
		...
		// memanggil view tambah
		 $kantors = DB::table('kantor')
		 		 ->where('id_kantor', '=', 'K07')
		 		 ->get();
		return view('tambah7', ['kantors' => $kantors , 'id_barang' => $id_barang]); 
	}
