...
class Sekre10Controller extends Controller
{
     /**
...

    {
    	$data = DB::table('barang')
    		  ...
    		  ->where('barang.id_kantor', '=', 'K10')
    		  ->get();
    		  return view('sekre10', ['data' => $data]);
    }
    ...
    public function create()
	{
		...
		// memanggil view tambah
		 $kantors = DB::table('kantor')
		 		 ->where('id_kantor', '=', 'K10')
		 		 ->get();
		return view('tambah10', ['kantors' => $kantors , 'id_barang' => $id_barang]); 
	}
