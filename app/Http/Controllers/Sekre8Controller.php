...
class Sekre8Controller extends Controller
{
     /**
...

    {
    	$data = DB::table('barang')
    		  ...
    		  ->where('barang.id_kantor', '=', 'K08')
    		  ->get();
    		  return view('sekre8', ['data' => $data]);
    }
    ...
    public function create()
	{
		...
		// memanggil view tambah
		 $kantors = DB::table('kantor')
		 		 ->where('id_kantor', '=', 'K08')
		 		 ->get();
		return view('tambah8', ['kantors' => $kantors , 'id_barang' => $id_barang]); 
	}
