...
class Sekre4Controller extends Controller
{
     /**
...

    {
    	$data = DB::table('barang')
    		  ...
    		  ->where('barang.id_kantor', '=', 'K04')
    		  ->get();
    		  return view('sekre4', ['data' => $data]);
    }
    ...
    public function create()
	{
		...
		// memanggil view tambah
		 $kantors = DB::table('kantor')
		 		 ->where('id_kantor', '=', 'K04')
		 		 ->get();
		return view('tambah4', ['kantors' => $kantors , 'id_barang' => $id_barang]); 
	}
