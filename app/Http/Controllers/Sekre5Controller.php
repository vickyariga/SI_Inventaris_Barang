...
class Sekre5Controller extends Controller
{
     /**
...

    {
    	$data = DB::table('barang')
    		  ...
    		  ->where('barang.id_kantor', '=', 'K05')
    		  ->get();
    		  return view('sekre5', ['data' => $data]);
    }
    ...
    public function create()
	{
		...
		// memanggil view tambah
		 $kantors = DB::table('kantor')
		 		 ->where('id_kantor', '=', 'K05')
		 		 ->get();
		return view('tambah5', ['kantors' => $kantors , 'id_barang' => $id_barang]); 
	}
