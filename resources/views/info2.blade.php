...
<body class="">
  ...
  <!--  @foreach($kantors as $d)
    ...
    @endforeach -->
     ...
     <tr style="text-align: center">
          <td>K11</td>
          <td>Badan Kepegawaian dan Pengembangan Sumber Daya Manusia (BKPSDM)</td>
          <td>
             <center><a class="btn btn-success" href="#"><i class="nc-icon nc-alert-circle-i" style="font-size: 20px"></i></a></center>
          </td>
        </tr>
        <tr style="text-align: center">
          <td>K12</td>
          <td>Badan Perencanaan Pembangunan Daerah (BAPPEDA)</td>
          <td>
             <center><a class="btn btn-success" href="#"><i class="nc-icon nc-alert-circle-i" style="font-size: 20px"></i></a></center>
          </td>
        </tr>
        <tr style="text-align: center">
          <td>K13</td>
          <td>Badan Pendapatan Daerah (BAPENDA)</td>
          <td>
             <center><a class="btn btn-success" href="#"><i class="nc-icon nc-alert-circle-i" style="font-size: 20px"></i></a></center>
          </td>
        </tr>
        <tr style="text-align: center">
          <td>K14</td>
          <td>Badan Pengelolaan Keuangan dan Aset Daerah (BPKAD)</td>
          <td>
             <center><a class="btn btn-success" href="#"><i class="nc-icon nc-alert-circle-i" style="font-size: 20px"></i></a></center>
          </td>
        </tr>
