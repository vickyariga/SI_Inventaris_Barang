...
<body class="">
  <div class="wrapper ">
    ...
    <div class="main-panel">
              ...
              @foreach($barang as $p)
                <form action="/update2/sekre2" method="post">
                  {{ csrf_field() }}
                  <div class="form-group">
                  <label>Kode Barang</label>  
                  <input class="form-control" type="text" name="id_barang" value="{{ $p->id_barang }}" readonly="readonly"> 
                  </div>

                  <div class="form-group">
                  <label>Nama Barang</label>  
                  <input class="form-control" type="text" name="nama_barang" value="{{ $p->nama_barang }}" required="required">
                  </div>
